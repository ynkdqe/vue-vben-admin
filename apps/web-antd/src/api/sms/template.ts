...
function normalize(res: any): ListResult<SmsTemplate> {
...
export async function fetchSmsTemplateList(params: PageQuery = {}) {
  ...
  const res = await requestClient.get<any>('/api/sms/template', {
    params: query,
    responseReturn: 'body',
  });
